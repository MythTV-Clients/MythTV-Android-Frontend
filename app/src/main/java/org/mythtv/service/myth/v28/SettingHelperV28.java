 ...
 *
 */
public class SettingHelperV28 extends AbstractBaseHelper {
	...
	private static SettingHelperV28 singleton;
	
	/**
	 * Returns the one and only SettingHelperV28. init() must be called before 
	 * any 
	 * @return
	 */
	public static SettingHelperV28 getInstance() {
		if( null == singleton ) {
			
			synchronized( SettingHelperV28.class ) {

				if( null == singleton ) {
					singleton = new SettingHelperV28();
				}
