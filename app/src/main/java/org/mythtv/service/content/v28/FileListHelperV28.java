 ...
 *
 */
public class FileListHelperV28 extends AbstractBaseHelper {

	private static final String TAG = FileListHelperV28.class.getSimpleName();
	
	private static final ApiVersion mApiVersion = ApiVersion.v027;
	
	private static MythServicesTemplate mMythServicesTemplate;

	private static FileListHelperV28 singleton;
	
	/**
	 * Returns the one and only FileListHelperV28. init() must be called before 
	 * any 
	 * @return
	 */
	public static FileListHelperV28 getInstance() {
		if( null == singleton ) {
			
			synchronized( FileListHelperV28.class ) {

				if( null == singleton ) {
					singleton = new FileListHelperV28();
				}
