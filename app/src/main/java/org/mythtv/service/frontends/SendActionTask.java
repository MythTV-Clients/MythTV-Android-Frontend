		...
		switch( apiVersion ) {
			case v025 :
				...
				if( null != mythServicesTemplateV25 ) {
					mythServicesTemplateV25.frontendOperations().sendAction( action, null, 0, 0, ETagInfo.createEmptyETag() );
				}
...
//				break;
			...
			default :
				...
				if( null != mythServicesTemplateV27Default ) {
					mythServicesTemplateV27Default.frontendOperations().sendAction( action, null, 0, 0, ETagInfo.createEmptyETag() );
				}
