 ...
 * 
 */
package org.mythtv.service.frontends.v25;
 ...
 *
 */
public class StatusHelperV25 extends AbstractBaseHelper {

	private static final String TAG = StatusHelperV25.class.getSimpleName();
	
	private static final ApiVersion mApiVersion = ApiVersion.v025;
	
	private static MythServicesTemplate mMythServicesTemplate;

	private static StatusHelperV25 singleton;
	 ...
	 * @return
	 */
	public static StatusHelperV25 getInstance() {
		if( null == singleton ) {
	...
	private Status load( org.mythtv.services.api.v025.beans.FrontendStatus versionStatus ) {
