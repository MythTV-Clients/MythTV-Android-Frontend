...
public class FrontendConstants extends AbstractBaseConstants {
	...
	public static final String FIELD_HOSTNAME = "URL";
	public static final String FIELD_HOSTNAME_DATA_TYPE = "TEXT";
	
	public static final String FIELD_PORT = "PORT";
	public static final String FIELD_PORT_DATA_TYPE = "INTEGER";
	...
	public static final String[] COLUMN_MAP = { _ID,
		FIELD_NAME, FIELD_HOSTNAME, FIELD_PORT, FIELD_AVAILABLE,
	...
	static {
		...
		insert.append( FIELD_PORT ).append( "," );
		...
		update.append( FIELD_PORT ).append( " = ?, " );
