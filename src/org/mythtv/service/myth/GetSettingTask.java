	...
	protected String doInBackground( String... params ) {
		...
		switch( apiVersion ) {
			case v026 :
				...
				setting = SettingHelperV26.process( mLocationProfile, settingName, settingDefault );
				
				break;
			case v027 :

				setting = SettingHelperV27.process( mLocationProfile, settingName, settingDefault );
