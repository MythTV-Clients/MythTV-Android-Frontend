 ...
 *
 */
public class StorageGroupHelperV28 extends AbstractBaseHelper {
	...
	private static StorageGroupHelperV28 singleton;
	
	/**
	 * Returns the one and only StorageGroupHelperV28. init() must be called before 
	 * any 
	 * @return
	 */
	public static StorageGroupHelperV28 getInstance() {
		if( null == singleton ) {
			
			synchronized( StorageGroupHelperV28.class ) {

				if( null == singleton ) {
					singleton = new StorageGroupHelperV28();
				}
