 ...
 *
 */
public class RecordingRuleHelperV25 extends AbstractBaseHelper {

	private static final String TAG = RecordingRuleHelperV25.class.getSimpleName();
	...
	private static RecordingRuleHelperV25 singleton;
	
	/**
	 * Returns the one and only RecordingRuleHelperV25. init() must be called before 
	 * any 
	 * @return
	 */
	public static RecordingRuleHelperV25 getInstance() {
		if( null == singleton ) {
			...
			synchronized( RecordingRuleHelperV25.class ) {

				if( null == singleton ) {
					singleton = new RecordingRuleHelperV25();
				}
	 ...
	 */
	private RecordingRuleHelperV25() { }
	...
	private void downloadRecordinRules( final Context context, final LocationProfile locationProfile ) throws RemoteException, OperationApplicationException {
		...
		ResponseEntity<org.mythtv.services.api.v025.beans.RecRuleList> responseEntity = mMythServicesTemplate.dvrOperations().getRecordScheduleList( null, null, etag );
	...
	private int load( final Context context, final LocationProfile locationProfile, final org.mythtv.services.api.v025.beans.RecRule[] recordingRules ) throws RemoteException, OperationApplicationException {
...
//		Log.v( TAG, "load : exit" );
	...
	private void processRecordingRule( final Context context, final LocationProfile locationProfile, ArrayList<ContentProviderOperation> ops, org.mythtv.services.api.v025.beans.RecRule recRule ) {
...
//		Log.v( TAG, "load : deleting recRules" );
	...
	private int addRecordingRule( final Context context, final LocationProfile locationProfile, final RecRule recordingRule ) throws RemoteException, OperationApplicationException {
		...
		org.mythtv.services.api.v025.beans.RecRule versionRecRule = convertRecRuleToRecRuleV25( recordingRule );
	...
	private ContentValues convertRecRuleToContentValues( final LocationProfile locationProfile, final org.mythtv.services.api.v025.beans.RecRule recRule ) {
