 ...
 * 
 */
package org.mythtv.service.guide.v25;
...
import org.mythtv.services.api.v025.beans.ProgramGuide;
 ...
 *
 */
public class ProgramGuideHelperV25 extends AbstractBaseHelper {

	private static final String TAG = ProgramGuideHelperV25.class.getSimpleName();
	...
	private static ProgramGuideHelperV25 singleton;
	
	/**
	 * Returns the one and only ProgramGuideHelperV25. init() must be called before 
	 * any 
	 * @return
	 */
	public static ProgramGuideHelperV25 getInstance() {
		if( null == singleton ) {
			
			synchronized( ProgramGuideHelperV25.class ) {

				if( null == singleton ) {
					singleton = new ProgramGuideHelperV25();
				}
	...
	public static Program findProgram( final Context context, final LocationProfile locationProfile, Integer channelId, DateTime startTime ) {
		...
		Program program = ProgramHelperV25.getInstance().findProgram( context, locationProfile, ProgramConstants.CONTENT_URI_GUIDE, ProgramConstants.TABLE_NAME_GUIDE, channelId, startTime );
	...
	public static boolean deleteProgram( final Context context, final LocationProfile locationProfile, Integer channelId, DateTime programStartTime, DateTime recordingStartTime, Integer recordId ) {
		...
		boolean removed = ProgramHelperV25.getInstance().deleteProgram( context, locationProfile, ProgramConstants.CONTENT_URI_GUIDE, ProgramConstants.TABLE_NAME_GUIDE, channelId, programStartTime, recordingStartTime, recordId );
	...
	private static void downloadProgramGuide( final Context context, final LocationProfile locationProfile ) throws RemoteException, OperationApplicationException {
		...
		ProgramHelperV25.getInstance().deletePrograms( context, locationProfile, ops, ProgramConstants.CONTENT_URI_GUIDE, ProgramConstants.TABLE_NAME_GUIDE );
