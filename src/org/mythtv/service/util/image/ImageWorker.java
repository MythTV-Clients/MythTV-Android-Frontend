...
package org.mythtv.service.util.image;
...
public abstract class ImageWorker {
     ...
     */
    public void loadImage(Object data, Object type, ImageView imageView, TextView textView) {
        if (data == null) {
            return;
        }
        ...
        if (bitmap != null) {
            ...
            final BitmapWorkerTask task = new BitmapWorkerTask(imageView, textView);
            ...
            task.executeOnExecutor(AsyncTask.DUAL_THREAD_EXECUTOR, data, type);
        }
    }
     ...
     */
    protected abstract Bitmap processBitmap(Object data, Object type);
...
//            }
            ...
            data = params[0];
            type = params[1];
            final String dataString = String.valueOf(data + "_" + type);
            Bitmap bitmap = null;
            ...
            if (bitmap == null && !isCancelled() && getAttachedImageView() != null
                    && !mExitTasksEarly) {
                bitmap = processBitmap(params[0], params[1]);
            }
...
//                }
                ...
                Log.d(TAG, "onPostExecute - no bitmap, showing text");
