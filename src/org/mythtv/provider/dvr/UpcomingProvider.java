 ...
 *
 */
public class UpcomingProvider extends AbstractMythtvContentProvider {

	private static final String TAG = UpcomingProvider.class.getSimpleName();
	 ...
	 */
	private static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.mythtv.dvr.upcoming";

	/**
	 * The MIME type of a single event
	 */
	private static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.mythtv.dvr.upcoming";
	...
	public boolean onCreate() {
		...
		uriMatcher.addURI( UpcomingConstants.AUTHORITY, "upcoming", PROGRAMS );
		uriMatcher.addURI( UpcomingConstants.AUTHORITY, "upcoming/#", PROGRAM_ID );
	...
	public Cursor query( Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder ) {
		...
		Cursor cursor = db.query( UpcomingConstants.TABLE_NAME, projection, selection, selectionArgs, null, null, sortOrder );
	...
	public Uri insert( Uri uri, ContentValues values ) {
		...
		long id = db.insertOrThrow( UpcomingConstants.TABLE_NAME, null, values );

		// Notify any watchers of the change
		Uri newUri = ContentUris.withAppendedId( UpcomingConstants.CONTENT_URI, id );
	...
	public int delete( Uri uri, String selection, String[] selectionArgs ) {
		...
		int affected = db.delete( UpcomingConstants.TABLE_NAME, BaseColumns._ID
				+ "="
				+ recordId
	...
	public int update( Uri uri, ContentValues values, String selection, String[] selectionArgs ) {
		...
		String recordId = Long.toString( ContentUris.parseId( uri ) );
		int affected = db.update( UpcomingConstants.TABLE_NAME, values, BaseColumns._ID
				+ "="
				+ recordId
				+ ( !TextUtils.isEmpty( selection ) ? " AND (" + selection + ')' : "" ), selectionArgs );
