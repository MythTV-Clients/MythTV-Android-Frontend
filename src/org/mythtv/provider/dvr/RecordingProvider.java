...
//	private static final String TAG = RecordingProvider.class.getSimpleName();
	 ...
	 */
	private static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.mythtv.recording";

	/**
	 * The MIME type of a single event
	 */
	private static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.mythtv.recording";
	...
	public boolean onCreate() {
		...
		uriMatcher.addURI( RecordingConstants.AUTHORITY, "recording", RECORDINGS );
		uriMatcher.addURI( RecordingConstants.AUTHORITY, "recording/#", RECORDING_ID );
	...
	public Cursor query( Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder ) {
		...
		if( uriMatcher.match( uri ) == RECORDING_ID ) {
		...
		Cursor cursor = db.query( RecordingConstants.TABLE_NAME, projection, selection, selectionArgs, null, null, sortOrder );
	...
	public String getType( Uri uri ) {
		...
		switch( uriMatcher.match( uri ) ) {
			case RECORDINGS:
		//		Log.v( TAG, "getType : exit, recordings selected" );

				return CONTENT_TYPE;
			case RECORDING_ID:
		//		Log.v( TAG, "getType : exit, recording id selected" );
	...
	public Uri insert( Uri uri, ContentValues values ) {
		...
		long id = db.insertOrThrow( RecordingConstants.TABLE_NAME, null, values );

		// Notify any watchers of the change
		Uri newUri = ContentUris.withAppendedId( RecordingConstants.CONTENT_URI, id );
	...
	public int delete( Uri uri, String selection, String[] selectionArgs ) {
		...
		int affected = db.delete( RecordingConstants.TABLE_NAME, RecordingConstants._ID
				+ "="
				+ recordId
	...
	public int update( Uri uri, ContentValues values, String selection, String[] selectionArgs ) {
		...
		String recordId = Long.toString( ContentUris.parseId( uri ) );
		int affected = db.update( RecordingConstants.TABLE_NAME, values, RecordingConstants._ID
				+ "="
				+ recordId
				+ ( !TextUtils.isEmpty( selection ) ? " AND (" + selection + ')' : "" ), selectionArgs );
